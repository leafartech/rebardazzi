...
export default function Modal({ modal, setModal }: ModalProps) {
    ...
    // var tag = 'lead-balletdozero-21-23-OUT'
    var apiKey = '53be2cd2bb8d905869263e2c944c03ec';
    var listId = 'd6c9c23fba';

    // Crie um objeto de dados a ser enviado para o Mailchimp
    var data2 = {
        status: 'subscribed'
    };

    // if (tag) {
    //     data.tags = [{ name: 'Tag do Lead', value: tag }]; // Adiciona a tag, se fornecida
    // }
    ...
    fetch(`https://53be2cd2bb8d905869263e2c944c03ec.api.mailchimp.com/3.0/lists/d6c9c23fba/members`, {
        ...
        .then(response => {
            if (response.status === 200) {
                // Redirecione para a página de agradecimento desejada
                window.location.href = 'https://rebardazzi.com.br/jornada-obrigado';
            } else {
