...
export default function Modal({ modal }: ModalProps) {
    return (
        <div className={`fixed left-0 top-0 w-full h-screen flex justify-center items-center z-50 ${modal ? 'block' : 'hidden'}`}>
            ...
            <form className="w-[440px] py-12 px-12 z-50 rounded-sm bg-[#A56260] validate" action="https://gmail.us13.list-manage.com/subscribe/post?u=f8afbe3d4af930883e1a7e8cd&amp;id=d6c9c23fba&amp;f_id=001609e3f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form">
                {/* <img src="./images/logo.svg" alt="" className="w-32 sm:w-32" /> */}
                <h2 className="text-white font-bold text-2xl mb-6">Quase lá...</h2>
                <div className="">
                    <div className="flex flex-col gap-1 mb-2 sub">
                        <label className="text-white">Email</label>
                        <input type="email" name="EMAIL" className="text-sm text-white/70 outline-none bg-transparent border border-zinc-300/40 rounded-full py-2 px-2 w-full" id="mce-EMAIL" required />
                    </div>
                    <div className="flex flex-col gap-1 mb-2 sub">
                        <label className="text-white">Seu primeiro nome</label>
                        <input type="text" name="FNAME" className="text-sm text-white/70 outline-none bg-transparent border border-zinc-300/40 rounded-full py-2 px-2 w-full" id="mce-FNAME" required />
                    </div>
                    <div className="flex flex-col gap-1 mb-2 sub">
                    ...
                    <input type="hidden" name="MMERGE6" className=" text" id="mce-MMERGE6" value="" />
                    <input type="hidden" name="MMERGE7" className=" text" id="mce-MMERGE7" value="" />
                    <input type="hidden" name="MMERGE8" className=" text" id="mce-MMERGE8" value="" />
                    <input type="hidden" name="MMERGE9" className=" text" id="mce-MMERGE9" value="" />
                    <input type="hidden" name="MMERGE10" className=" text" id="mce-MMERGE10" value="" />
                </div>
