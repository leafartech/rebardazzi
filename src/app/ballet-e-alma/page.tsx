            ...
            <header className="header-2 pt-12 pb-6 sm:pt-24 sm:pb-32 sm:flex sm:justify-center sm:items-start px-4 sm:px-0">
                <div className="w-full flex flex-col justify-center items-center max-w-3xl">
                    ...
                    <div className="text-center mt-12 flex flex-col gap-4 items-center">
                        ...
                        <a href="https://pay.kiwify.com.br/32qbG1C" className="text-white bg-green-600 rounded-lg text-sm sm:text-base sm:w-full sm:px-6 sub sm:max-w-lg py-4 uppercase tracking-widest">Receber informações exclusivas da black november</a>
                    </div>
                </div>
            </header>
            <main>
                <Section classNameS="back-2">
                    <div className="max-w-7xl w-full flex flex-col sm:grid sm:grid-cols-2 items-center">
                        ...
                        <div className="flex flex-col text-my gap-3 sm:px-4">
                            ...
                            <a href="https://pay.kiwify.com.br/32qbG1C" className="text-center text-white text-sm sm:text-base bg-green-600 rounded-lg sm:w-full sm:px-6 sub sm:max-w-lg py-4 uppercase tracking-widest">Receber informações exclusivas</a>
                        </div>
                    </div>
                </Section>
                ...
                <Section classNameS="py-12 sm:py-16 bg-my">
                    <div className="flex flex-col sm:gap-4 items-center">
                        ...
                        <a href="https://pay.kiwify.com.br/32qbG1C" className="mt-4 text-center text-sm sm:text-base w-full text-white bg-green-600 rounded-lg sm:w-full sm:px-6 sub sm:max-w-lg py-4 uppercase tracking-widest">Receber informações exclusivas</a>
                    </div>
                </Section>
                <Section classNameS="back-2 py-6 sm:py-24">
                    <div className="max-w-7xl w-full flex flex-col sm:grid sm:grid-cols-2 items-center">
                        ...
                        <div className="flex flex-col text-my gap-3 mt-4 sm:mt-0 sm:px-4">
                            ...
                            <a href="https://pay.kiwify.com.br/32qbG1C" className="text-center text-sm sm:text-base text-white bg-green-600 rounded-lg sm:w-full sm:px-6 sub sm:max-w-lg py-4 uppercase tracking-widest">Receber informações exclusivas</a>
                        </div>
                    </div>
                </Section>
            </main>
